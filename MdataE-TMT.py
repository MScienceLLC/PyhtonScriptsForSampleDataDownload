...
logging.basicConfig(filename='MDataE-TMT.log',level=logging.DEBUG)  	
...
def upload_to_S3Bucket():
     ...
     try:
          ...
          # Get file info
          source_path = os.path.dirname(os.path.abspath("MDataE-TMT.csv"))+'\MDataE-TMT.csv'
...
if __name__ == '__main__':
    ...
    try:
            ...
            convert_data(data, "MDataE-TMT.csv")
            upload_to_S3Bucket()
    except Exception as e:
         logging.debug(e)
