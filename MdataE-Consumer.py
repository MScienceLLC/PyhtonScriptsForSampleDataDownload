...
logging.basicConfig(filename='MDataE-Consumer.log',level=logging.DEBUG) 	
...
def upload_to_S3Bucket():
     ...
     try:
          ...
          # Get file info
          source_path = os.path.dirname(os.path.abspath("MDataE-Consumer.csv"))+'\MDataE-Consumer.csv'
...
if __name__ == '__main__':
    ...
    try:
            ...
            convert_data(data, "MDataE-Consumer.csv")
            upload_to_S3Bucket()
    except Exception as e:
         logging.debug(e)
